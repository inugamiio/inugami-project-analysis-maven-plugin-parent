= io.inugami.demo:spring-boot-training-rest:0.0.2-SNAPSHOT _(2022-02-02T21:49:11.606804)_
:toc:
...
== Authors
- Julien HALLER (jhaller@smartwavesa.com)
- Patrick Guillerm (pguillerm@smartwavesa.com)
- Patrick Guillerm (patrickguillerm@gmail.com)
- Yannick Marrec ()
