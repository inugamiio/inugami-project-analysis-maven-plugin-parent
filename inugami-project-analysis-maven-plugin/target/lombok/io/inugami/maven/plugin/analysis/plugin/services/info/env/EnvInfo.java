...
public class EnvInfo implements ProjectInformation, QueryConfigurator {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(EnvInfo.class);
    // =========================================================================
    // ATTRIBUTES
    // =========================================================================
    ...
    public void process(final InfoContext context) {
        ...
        final String query = TemplateRendering.render(QueriesLoader.getQuery(QUERIES.get(0)), configure(QUERIES.get(0), null, context.getConfiguration()));
        log.info("query:\n{}", query);
