...
public class SpringFeignClientAnalyzer extends SpringRestControllersAnalyzer implements ClassAnalyzer {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SpringFeignClientAnalyzer.class);
    ...
    protected String getApiName(final Class<?> clazz) {
        return ReflectionService.ifHasAnnotation(clazz, FeignClient.class, FeignClient::name, () -> clazz.getSimpleName());
    }
