...
public class ArtifactResolverListener implements ResolutionListener {
    ...
    private Gav buildGav(final Artifact artifact) {
        return Gav.builder().groupId(artifact.getGroupId()).artifactId(artifact.getArtifactId()).version(artifact.getVersion()).type(artifact.getType()).build();
    }
    ...
    @java.lang.SuppressWarnings("all")
    public Gav getParentArtifact() {
        return this.parentArtifact;
    }

    @java.lang.SuppressWarnings("all")
    public Gav getCurrentArtifact() {
        return this.currentArtifact;
    }

    @java.lang.SuppressWarnings("all")
    public List<Gav> getBuffer() {
        return this.buffer;
    }
}
