...
public class Unpublish implements ProjectInformation {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(Unpublish.class);
    // =========================================================================
    // ATTRIBUTES
    // =========================================================================
    ...
    public static List<String> buildDeletePublishRelation(final Node artifactNode, final Node env, final boolean justThisVersion) {
    ...
    private static String buildDeleteHaveArtifactVersion(final Node artifactNode, final Node env, final boolean justThisVersion) {
        final JsonBuilder query = new JsonBuilder();
    ...
    private Node buildEnvNode(final ConfigHandler<String, String> configuration) {
        ...
        final String levelStr = ifNull(configuration.get(LEVEL), () -> ConsoleTools.askQuestion("environment level ?", "1"));
        final int level = convertLevel(levelStr);
        properties.put("level", level);
        final String envType = ifNull(configuration.get(ENV_TYPE), () -> ConsoleTools.askQuestion("environment type ?"));
        if (envType != null) {
