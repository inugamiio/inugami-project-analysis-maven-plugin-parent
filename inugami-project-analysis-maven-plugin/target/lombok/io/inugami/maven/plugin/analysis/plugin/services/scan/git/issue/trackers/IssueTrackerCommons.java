...
public final class IssueTrackerCommons {
    ...
    public static enum TicketType {
        MERGE_REQUEST("MergeRequest", "pr_"), ISSUE("Issue", "issue_"), ISSUE_LABEL("IssueLabel", "issue_label_");
        private final String nodeType;
        private final String nodePrefix;

        @java.lang.SuppressWarnings("all")
        private TicketType(final String nodeType, final String nodePrefix) {
