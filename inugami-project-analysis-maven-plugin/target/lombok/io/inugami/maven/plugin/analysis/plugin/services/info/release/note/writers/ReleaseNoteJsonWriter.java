...
public class ReleaseNoteJsonWriter implements ReleaseNoteWriter {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ReleaseNoteJsonWriter.class);
    // =========================================================================
    // ATTRIBUTES
    // =========================================================================
    ...
    public void process(final ReleaseNoteResult releaseNote, final InfoContext context) {
        ...
        final File file = FilesUtils.buildFile(context.getBuildDir(), "release-note-" + context.getProject().getVersion() + ".json");
        ...
        if (Boolean.parseBoolean(context.getConfiguration().grabOrDefault(ATTACH, "true"))) {
            ...
            final DefaultArtifact artifact = new DefaultArtifact(project.getGroupId(), project.getArtifactId(), project.getVersion(), "compile", "json", "release-note", context.getArtifactHandler());
