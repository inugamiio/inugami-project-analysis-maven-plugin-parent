...
class ReleaseNoteAsciidocWriterTest {
    ...
    private Map<String, Object> buildCommit(final String date, final String uid, final String author, final String message) {
        final Map<String, Object> result = new LinkedHashMap<>();
        result.put(ReleaseNoteAsciidocWriter.DATE, LocalDateTime.parse(date));
        result.put(ReleaseNoteAsciidocWriter.COMMIT_UID, uid);
        result.put(ReleaseNoteAsciidocWriter.AUTHOR, author);
        result.put(ReleaseNoteAsciidocWriter.MESSAGE, message);
        return result;
    }
